 ...
 */
   ...
   /* Services Box Slider (#services-slider) is now initialized from
      resources/js/Pages/Public/Website/Index.vue's mounted() hook instead
      of here, so it also re-runs correctly on Inertia SPA navigation to
      the homepage - keeping it here too would double-init it on a hard
      page load. */
   ...
   /* #rev_arrows (homepage hero) is now initialized from
      resources/js/Pages/Public/Website/Index.vue's mounted() hook instead
      of here - see the note by #services-slider above. */
